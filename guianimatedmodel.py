"""
Created on Mon Nov 04 11:22:00 2021

Parallel model to run the environment on an animated screen with GUI:
Opens a window with a menu to start the run, then
creates agents in an environment read from a CSV file 'in.txt', 
makes them move, consume and share resources.
...
# Display - replaced with following code
...
# Build the main window and canvas, build the menu
root = tkinter.Tk()
root.wm_title("GUI Animated Model")
